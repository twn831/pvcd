...
// .wrangler/tmp/bundle-LbKehY/checked-fetch.js
...
// .wrangler/tmp/bundle-LbKehY/strip-cf-connecting-ip-header.js
...
function buildAuthCookie(token, isLocal = false) {
  if (isLocal) {
    return `${COOKIE_NAME}=${token}; Path=/; Max-Age=${COOKIE_MAX_AGE}`;
  }
  ...
  <script>
    ...
    document.getElementById('loginForm').onsubmit = async (e) => {
      ...
      try {
        ...
        if (setCookie) {
          document.cookie = setCookie.split(';')[0] + '; Path=/; Max-Age=' + (30 * 24 * 60 * 60);
        }
      ...
      if (body.username === USERNAME && body.password === PASSWORD) {
        ...
        return new Response(JSON.stringify({ ok: true }), {
          headers: {
            ...
            "Set-Cookie": buildAuthCookie(token, isLocal)
          }
        });
      }
...
// .wrangler/tmp/bundle-LbKehY/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-LbKehY/middleware-loader.entry.ts
